    ...
    public static class ModelBuilder
    {
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("Label", "Label")
                                      .Append(mlContext.Transforms.Categorical.OneHotEncoding(new[] { new InputOutputColumnPair("SepalLength", "SepalLength"), new InputOutputColumnPair("SepalWidth", "SepalWidth"), new InputOutputColumnPair("PetalLength", "PetalLength"), new InputOutputColumnPair("PetalWidth", "PetalWidth") }))
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.OneVersusAll(mlContext.BinaryClassification.Trainers.LinearSvm(labelColumnName: "Label", featureColumnName: "Features"), labelColumnName: "Label")
